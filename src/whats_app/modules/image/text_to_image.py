...
from whats_app.core.exceptions import TextToImageError
from whats_app.core.prompts import IMAGE_ENHANCEMENT_PROMPT, IMAGE_SCENARIO_PROMPT
...
class TextToImage:
    ...
    async def generate_image(self, prompt: str, output_path: str = "") -> bytes:
        ...
        try:
            ...
            raise TextToImageError(
                f"Failed to generate image: {str(e)}") from e
    ...
    async def create_scenario(self, chat_history: list = None) -> ScenarioPrompt:
        ...
        try:
            ...
            raise TextToImageError(
                f"Failed to create scenario: {str(e)}") from e
    ...
    async def enhance_prompt(self, prompt: str) -> str:
        ...
        try:
            ...
            raise TextToImageError(
                f"Failed to enhance prompt: {str(e)}") from e
