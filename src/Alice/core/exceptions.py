"""
This module defines custom exceptions used throughout the Alice AI system.
These exceptions are raised when specific errors occur during various AI processing tasks.
"""
