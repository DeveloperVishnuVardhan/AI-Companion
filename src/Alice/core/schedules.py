"""
This module defines the daily schedules and activities for Alice (Ava) throughout the week.
These schedules are used to provide context-aware responses and maintain a consistent personality
by simulating a realistic daily routine for the AI companion.

Each day's schedule is defined as a dictionary with time slots as keys and activities as values.
The schedules reflect Alice's interests in ML, art, astrobiology, and her professional life at Groq.
"""

# Agents schedules in the week.
MONDAY_SCHEDULE = {
