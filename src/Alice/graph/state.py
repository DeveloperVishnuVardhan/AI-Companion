"""
This module defines the state management for the Alice AI system.
The state class tracks the current context, workflow, and data needed for conversation processing.
"""
...
class AICompanionState(MessagesState):
    ...
    Attributes:
        ...
        workflow:  The current workflow ALice is in. Can be "conversation", "image" or "audio".
